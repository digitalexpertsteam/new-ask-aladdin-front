...
export declare class CarouselComponent implements OnDestroy {
    ...
    set overlayProperties(properties: OverlayProperties);
    ...
    constructor(elementRef: ElementRef, ref: ChangeDetectorRef, overlayEventService: OverlayEventService);
    ngOnInit(): void;
